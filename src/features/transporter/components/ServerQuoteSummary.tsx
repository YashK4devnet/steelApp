...
export function ServerQuoteSummary({ quote }: ServerQuoteSummaryProps) {
  return (
    <div className="bg-white dark:bg-surface rounded-[24px] p-5 sm:p-6 shadow-[0_8px_24px_rgba(15,23,42,0.04)] dark:shadow-[0_8px_24px_rgba(0,0,0,0.35)] border border-slate-900/5 dark:border-white/10 flex flex-col gap-4">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-slate-100/70 dark:from-slate-800/60 dark:to-slate-800/30 p-4 rounded-[18px] border border-slate-200/60 dark:border-white/10 flex flex-col gap-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center items-start gap-2.5 sm:gap-3">
          ...
          <div className="hidden sm:flex items-center justify-center p-2 rounded-full bg-white dark:bg-slate-700 shadow-sm border border-slate-200 dark:border-slate-600">
            <ArrowRightIcon />
          </div>
      ...
      <div className="flex flex-col gap-1 bg-slate-50/70 dark:bg-slate-800/40 p-3.5 rounded-[16px] border border-slate-100 dark:border-white/5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-slate-50/70 dark:bg-slate-800/40 p-3.5 rounded-[16px] border border-slate-100 dark:border-white/5 flex flex-col gap-1">
